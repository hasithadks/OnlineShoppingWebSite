...
const  Quantity = props =>(
    <tr>
        ...
        <td className="col-sm-2">{props.quantity.item_productImage}</td>
        <td>
            <div>
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    addQuantity(e){
        ...
        console.log(`item size: ${this.state.file}`);
        ...
        // axios.post('http://localhost:5000/quantity/',newQuantity).then(res => console.log((res.data)));
    ...
    deleteQuantity(id){
        axios.delete('http://localhost:5000/quantity/delete/'+id)
            .then((res)=>{
            swal("Good job!", "Your Details has been Delete Successfully!", "success");
        },(err)=>{
            swal("Error!", "Try Again!", "warning");
        });
        this.setState({
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    editProduct(e){
        ...
        swal("Good job!", "Your Details has been Edit Successfully!", "success");
        //this.props.history.push('/');
    }
